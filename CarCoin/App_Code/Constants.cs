...
public class Constants
{
    ...
    public const string ETHEREUM_CONTRACT_ADDRESS = "0x3cb3f80544ea2b02f63ab6b12d1ef87cc62c04aa"; //2019 06 02 deploypublic const string ETHEREUM_CONTRACT_ABIFILE = public const string ETHEREUM_CONTRACT_ABIFILE = @"\ext\CarCoin\190531_contract\abi.json";
    public const string ETHEREUM_CONTRACT_ABIFILE = @"\ext\CarCoin\190531_contract\abi.json";
}